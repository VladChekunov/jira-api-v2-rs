...
[**bulk_set_issues_properties**](IssuePropertiesApi.md#bulk_set_issues_properties) | **POST** /rest/api/2/issue/properties | Bulk set issues properties
...
> bulk_set_issues_properties(issue_entity_properties)
