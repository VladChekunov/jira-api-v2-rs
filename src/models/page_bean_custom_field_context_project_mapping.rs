...
pub struct PageBeanCustomFieldContextProjectMapping {
    ...
    pub values: Option<Vec<models::CustomFieldContextProjectMapping>>,
}

impl PageBeanCustomFieldContextProjectMapping {
    /// A page of items.
    pub fn new() -> PageBeanCustomFieldContextProjectMapping {
