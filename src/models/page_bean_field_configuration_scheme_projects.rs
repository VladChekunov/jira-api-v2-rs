...
pub struct PageBeanFieldConfigurationSchemeProjects {
    ...
    pub values: Option<Vec<models::FieldConfigurationSchemeProjects>>,
}

impl PageBeanFieldConfigurationSchemeProjects {
    /// A page of items.
    pub fn new() -> PageBeanFieldConfigurationSchemeProjects {
