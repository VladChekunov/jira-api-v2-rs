...
pub struct PageBeanIssueSecurityLevelMember {
    /// The URL of the page.
    ...
    pub values: Option<Vec<models::IssueSecurityLevelMember>>,
}

impl PageBeanIssueSecurityLevelMember {
    /// A page of items.
    pub fn new() -> PageBeanIssueSecurityLevelMember {
