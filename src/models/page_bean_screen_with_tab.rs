...
/// PageBeanScreenWithTab : A page of items.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PageBeanScreenWithTab {
    /// The URL of the page.
    ...
    pub values: Option<Vec<models::ScreenWithTab>>,
}

impl PageBeanScreenWithTab {
    /// A page of items.
    pub fn new() -> PageBeanScreenWithTab {
