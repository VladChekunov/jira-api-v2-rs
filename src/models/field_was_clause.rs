...
impl FieldWasClause {
    ...
    pub fn new(field: models::JqlQueryField, operator: Operator, operand: models::JqlQueryClauseOperand, predicates: Vec<models::JqlQueryClauseTimePredicate>) -> FieldWasClause {
        FieldWasClause {
            field: Box::new(field),
            operator,
