...
pub struct PageBeanFieldConfigurationIssueTypeItem {
    ...
    pub values: Option<Vec<models::FieldConfigurationIssueTypeItem>>,
}

impl PageBeanFieldConfigurationIssueTypeItem {
    /// A page of items.
    pub fn new() -> PageBeanFieldConfigurationIssueTypeItem {
