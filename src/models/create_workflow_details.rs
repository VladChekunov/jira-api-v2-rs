...
pub struct CreateWorkflowDetails {
    ...
    pub statuses: Vec<models::CrateWorkflowStatusDetails>,
}

impl CreateWorkflowDetails {
    /// The details of a workflow.
    pub fn new(name: String, transitions: Vec<models::CreateWorkflowTransitionDetails>, statuses: Vec<models::CrateWorkflowStatusDetails>) -> CreateWorkflowDetails {
