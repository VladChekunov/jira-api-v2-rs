...
pub struct PageBeanWorkflowTransitionRules {
    /// The URL of the page.
    ...
    pub values: Option<Vec<models::WorkflowTransitionRules>>,
}

impl PageBeanWorkflowTransitionRules {
    /// A page of items.
    pub fn new() -> PageBeanWorkflowTransitionRules {
